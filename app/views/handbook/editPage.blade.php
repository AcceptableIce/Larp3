...
<div class="row">
	<div class="small-12 columns">
		<h1>
			{{$mode == 0 ? "Creating" : "Editing"}} {{$title == "" ? "a New Page" : $title}}
		</h1>
				...
				<div class="panel">
					...
					@if($type == 'write')
						<p class="setting-description">
							Write Permission is always at least Read Permission, even if left blank. 
							The creator of the page always has read and write permissions.
						</p> 
					@endif
				</div>
			@endforeach
