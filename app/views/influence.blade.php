...
<div class="influence-wrapper theme-wrapper">
	<div class="row">
		<div class="small-12 columns">
			...
			<p>
				The following are the influence caps for the various fields in the game. You cannot purchase more dots in a field than these caps. 
				If you already have more dots than the caps, then the "extra" ones cannot be used at this time. 
				Alone, you cannot perform an action which requires more points than the cap, but if you work with someone else you can double them.
				...
				<li>
					<div class="row">
						<div class="small-6 columns">
							<b class="inline right">{{$cap->definition->name}}:</b> 
						</div>
						<div class="small-6 columns">
							{{$cap->capacityString()}}
						</div>
